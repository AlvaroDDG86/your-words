<template>
  <div style="background: #0f2b48">
      ...
      >
        ...
        >
          <p class="uppercase tracking-loose w-full">
            Where do you save your words?
          </p>
          <h1 class="my-4 text-5xl font-bold leading-tight">
            It'd be incredible to save all your knoledge in one place!
          </h1>
          <p class="leading-normal text-2xl mb-8">
            Search a word, add your examples, annotations and traductions and so
            more!
          </p>
          <button
      ...
      <div class="container max-w-5xl mx-auto m-8">
        ...
        <div class="flex flex-wrap">
          ...
          <div class="w-full sm:w-1/2 p-6">
            <img
              :src="require('@/assets/undraw_Personalization_re_grty.png')"
              alt="personalization"
            />
          </div>
        </div>
        <div class="flex flex-wrap flex-col-reverse sm:flex-row">
          <div class="w-full sm:w-1/2 p-6 mt-6">
            <img
              :src="require('@/assets/undraw_Bibliophile_re_xarc.png')"
              alt="personalization"
            />
          </div>
          <div
    ...
    <section class="container mx-auto text-center py-6 text-gray-200">
      <h1
        class="
          w-full
          my-2
